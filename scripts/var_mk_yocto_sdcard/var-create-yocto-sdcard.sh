...
help() {
	bn=`basename $0`
	echo " Usage: MACHINE=<imx8mq-var-dart|imx8mm-var-dart|imx8qxp-var-som|imx8qxpb0-var-som|imx8qm-var-som|imx8mn-var-som> $bn <options> device_node"
	echo
	echo " options:"
...
if [[ $MACHINE != "imx8mq-var-dart" && $MACHINE != "imx8mm-var-dart" && \
      $MACHINE != "imx8qxp-var-som" && $MACHINE != "imx8qxpb0-var-som" && \
      $MACHINE != "imx8qm-var-som" && $MACHINE != "imx8mn-var-som" ]] ; then
	help
	exit 1
fi
