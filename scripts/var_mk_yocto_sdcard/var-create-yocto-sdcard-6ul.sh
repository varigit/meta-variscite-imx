...
YOCTO_ROOT=${YOCTO_ROOT:-~/var-mx6ul-mx7-yocto-krogoth}
YOCTO_BUILD=${YOCTO_BUILD:-${YOCTO_ROOT}/build_x11}
...
function copy_scripts
{
	...
	cp ${YOCTO_SCRIPTS_PATH}/install_yocto_6ul.sh		${P2_MOUNT_DIR}/usr/bin/install_yocto.sh
	cp ${YOCTO_SCRIPTS_PATH}/echos.sh			${P2_MOUNT_DIR}/usr/bin/echos.sh
